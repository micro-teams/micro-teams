...
// on the wire, which is the only place it is visible.
//
// Pressing the button, being asked, and ending up back at the door is the chat journey's now: it
// signs out through the real interface against a real server at the end of its run.
