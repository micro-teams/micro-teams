/*
 *  Description: 看现场 is the other moment an agent must be awake. Opening the live screen of an
 *               agent whose program died would otherwise show the frozen last frame of whatever
 *               killed it — a dead tmux pane that no keystroke reaches — and the human has no way
 *               to tell that from an agent that is merely quiet.
 *
